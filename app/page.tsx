  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-950">
      ...
      >
        ...
        {/* Social Media Links */}
        <div className={`flex ${sidebarOpen ? 'gap-3 p-4' : 'flex-col gap-2 p-4'} items-center ${sidebarOpen ? 'justify-start px-7' : 'justify-center'}`}>
          <a
            href="https://youtube.com"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-lg hover:bg-slate-800 transition-colors text-slate-400 hover:text-red-500"
            title="YouTube"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-lg hover:bg-slate-800 transition-colors text-slate-400 hover:text-indigo-500"
            title="Discord"
          >
            <svg
              className="w-5 h-5"
