...
export const MOCK_POSTS: Post[] = [
  ...
  // FOREX POSTS
  {
    id: "6",
    user: MOCK_USERS[4],
    content: "GBP/JPY looking strong! Breakout confirmed above 189.50. Targeting 191.00 with tight stop at 188.80. Risk management is key! 🇬🇧💴",
    topic: "forex",
  ...
  },
  {
    id: "7",
    user: MOCK_USERS[2],
    content: "Just hit my weekly profit target! 🎯 Focus was on EUR/JPY and GBP/USD pairs. The secret? Wait for confirmation, don't rush entries.",
    topic: "forex",
  ...
  },
  {
    id: "8",
    user: MOCK_USERS[5],
    content: "USD/CAD forming a beautiful head and shoulders pattern on the 4H chart. Waiting for neckline break at 1.3420 before entering short. 📉",
    topic: "forex",
  ...
  },
  {
    id: "9",
    user: MOCK_USERS[1],
    content: "NFP day tomorrow! Remember: wait for the initial volatility to settle before taking positions. Protect your capital first! 📊💼",
    topic: "forex",
  ...
  },
  {
    id: "10",
    user: MOCK_USERS[6],
    content: "AUD/USD showing weakness near 0.6500 resistance. Looking for a rejection here for short positions targeting 0.6420. 🐻",
    topic: "forex",
  ...
  },
  {
    id: "11",
    user: MOCK_USERS[3],
    content: "Scalping session recap: 15 trades, 12 wins on EUR/USD during London session. +$2,340 in 2 hours. Sticking to the plan works! ⚡💰",
    topic: "forex",
  ...
  },
  {
    id: "12",
    user: MOCK_USERS[0],
    content: "NZD/USD breaking out! Beautiful momentum setup with clean structure. Entry at 0.5890, targeting 0.5950. Let's ride this wave! 🌊📈",
    topic: "forex",
  ...
  // STOCKS POSTS
  {
    id: "13",
    user: MOCK_USERS[2],
    content: "AAPL showing strength! Broke above $180 resistance. Tech sector looking bullish this week. Already up $3,200 on this position. 🍎📱",
    topic: "stocks",
  ...
  },
  {
    id: "14",
    user: MOCK_USERS[5],
    content: "TSLA earnings play paid off! +$5,680 in one day. Volatility is your friend if you manage risk properly. Who else traded this? ⚡🚗",
    topic: "stocks",
  ...
  },
  {
    id: "15",
    user: MOCK_USERS[1],
    content: "S&P 500 hitting all-time highs! Riding this bull market with tight stops. Up $4,100 this week on index trades. 📈💪",
    topic: "stocks",
  ...
  },
  {
    id: "16",
    user: MOCK_USERS[4],
    content: "NVDA consolidating beautifully after the rally. Looking for a breakout above $890. AI stocks are on fire! 🔥💻",
    topic: "stocks",
  ...
  },
  {
    id: "17",
    user: MOCK_USERS[6],
    content: "Banking sector showing strength. Long on JPM and BAC. Financial stocks could lead the next leg up. +$2,890 so far. 🏦📊",
    topic: "stocks",
    timestamp: new Date(Date.now() - 330 * 60000),
    likes: 245,
    comments: 41,
    shares: 14,
  },
  {
    id: "18",
    user: MOCK_USERS[3],
    content: "META breaking resistance! Social media stocks making a comeback. Already locked in $1,850 profit, letting the rest ride. 📱✨",
    topic: "stocks",
    timestamp: new Date(Date.now() - 390 * 60000),
    likes: 298,
    comments: 44,
    shares: 17,
  },
  {
    id: "19",
    user: MOCK_USERS[0],
    content: "Energy sector rotation happening! XLE looking strong. Took positions in CVX and XOM. Oil prices supporting the move. ⛽📈",
    topic: "stocks",
    timestamp: new Date(Date.now() - 450 * 60000),
    likes: 201,
    comments: 35,
    shares: 11,
  },
  {
    id: "20",
    user: MOCK_USERS[2],
    content: "AMD crushing it! Chip stocks are the play right now. +$3,450 this morning alone. Semiconductor boom continues! 💻🚀",
    topic: "stocks",
    timestamp: new Date(Date.now() - 510 * 60000),
    likes: 412,
    comments: 71,
    shares: 25,
  },
  {
    id: "21",
    user: MOCK_USERS[5],
    content: "DIS breaking out after consolidation! Entertainment sector looking bullish. Entry at $92, targeting $98. 🎬📊",
    topic: "stocks",
    timestamp: new Date(Date.now() - 570 * 60000),
    likes: 178,
    comments: 29,
    shares: 8,
  },
  {
    id: "22",
    user: MOCK_USERS[1],
    content: "Pharma stocks showing momentum! PFE and JNJ both breaking higher. Healthcare rotation in play. +$2,120 today. 💊📈",
    topic: "stocks",
  ...
  // CRYPTO POSTS
  {
    id: "23",
    user: MOCK_USERS[4],
    content: "BTC breaking $68k! Bull run is real. Already secured $6,200 profit. HODLing the rest for $70k. To the moon! 🚀₿",
    topic: "crypto",
  ...
  },
  {
    id: "24",
    user: MOCK_USERS[3],
    content: "ETH pumping hard! $3,800 next stop. DeFi season is back! Staking rewards looking juicy. Who's bullish on ETH? 💎🔷",
    topic: "crypto",
  ...
  },
  {
    id: "25",
    user: MOCK_USERS[0],
    content: "SOL absolutely flying! $180 broken easily. Layer 1 tokens are the play this cycle. +$4,890 on this trade. 🌅🚀",
    topic: "crypto",
  ...
  },
  {
    id: "26",
    user: MOCK_USERS[6],
    content: "Altcoin season confirmed! MATIC, AVAX, and DOT all breaking out. Diversification paying off. +$3,670 across all positions. 🎯💰",
    topic: "crypto",
  ...
  },
  {
    id: "27",
    user: MOCK_USERS[2],
    content: "BNB holding strong above $600. Exchange tokens showing resilience. Accumulating more on dips. Long-term bullish! 🟡📊",
    topic: "crypto",
    timestamp: new Date(Date.now() - 285 * 60000),
    likes: 267,
    comments: 44,
    shares: 15,
  },
  {
    id: "28",
    user: MOCK_USERS[5],
    content: "LINK breaking major resistance! Oracle networks are essential. DeFi growth = LINK growth. +$2,340 and counting. 🔗💙",
    topic: "crypto",
    timestamp: new Date(Date.now() - 345 * 60000),
    likes: 312,
    comments: 53,
    shares: 18,
  },
  {
    id: "29",
    user: MOCK_USERS[1],
    content: "ADA finally waking up! Smart contract platforms rotating. Entry at $0.58, targeting $0.72. Patience with alts pays! 💚🚀",
    topic: "crypto",
    timestamp: new Date(Date.now() - 405 * 60000),
    likes: 423,
    comments: 76,
    shares: 26,
  },
  {
    id: "30",
    user: MOCK_USERS[4],
    content: "XRP lawsuit resolution creating momentum! Legal clarity = price action. Already up $3,120. This could run further! ⚖️💰",
    topic: "crypto",
    timestamp: new Date(Date.now() - 465 * 60000),
    likes: 512,
    comments: 89,
    shares: 33,
  },
  {
    id: "31",
    user: MOCK_USERS[3],
    content: "DOGE memecoin rally is insane! Up 40% this week. Sometimes you just ride the momentum. +$1,890 on this fun trade. 🐶🚀",
    topic: "crypto",
    timestamp: new Date(Date.now() - 525 * 60000),
    likes: 612,
    comments: 134,
    shares: 51,
  },
  {
    id: "32",
    user: MOCK_USERS[0],
    content: "UNI breakout confirmed! DEX tokens leading this rally. Watching for $15 target. DeFi summer 2.0? 🦄💜",
    topic: "crypto",
    timestamp: new Date(Date.now() - 585 * 60000),
    likes: 356,
    comments: 62,
    shares: 21,
  },
  // MATERIALS POSTS
  {
    id: "33",
    user: MOCK_USERS[2],
    content: "Just passed my Phase 2 evaluation! 🎉 Key takeaways: consistency beats big wins, always use stop losses, and journal every trade. You got this! 📝✅",
    topic: "materials",
  ...
  },
  {
    id: "34",
    user: MOCK_USERS[5],
    content: "Best trading books that changed my game: 'Market Wizards', 'Trading in the Zone', and 'Reminiscences of a Stock Operator'. Knowledge is power! 📚🧠",
    topic: "materials",
  ...
  },
  {
    id: "35",
    user: MOCK_USERS[1],
    content: "Prop firm tips: Focus on consistency over big wins. They want to see discipline and risk management. Small steady gains > boom and bust. 💡📊",
    topic: "materials",
    timestamp: new Date(Date.now() - 195 * 60000),
    likes: 634,
    comments: 112,
    shares: 48,
  },
  {
    id: "36",
    user: MOCK_USERS[4],
    content: "Mental game is 80% of trading! Started meditation and it's transforming my discipline. Less revenge trading, more patience. 🧘‍♂️💭",
    topic: "materials",
    timestamp: new Date(Date.now() - 255 * 60000),
    likes: 523,
    comments: 94,
    shares: 39,
  },
  {
    id: "37",
    user: MOCK_USERS[6],
    content: "My trading setup: 3 monitors, TradingView Premium, economic calendar, and a journal. Tools matter but mindset matters more! 🖥️⚙️",
    topic: "materials",
    timestamp: new Date(Date.now() - 315 * 60000),
    likes: 401,
    comments: 71,
    shares: 28,
  },
  {
    id: "38",
    user: MOCK_USERS[3],
    content: "Risk management rule: Never risk more than 1% per trade. This saved my account countless times. Consistency is everything! 🛡️💰",
    topic: "materials",
    timestamp: new Date(Date.now() - 375 * 60000),
    likes: 789,
    comments: 145,
    shares: 62,
  },
  {
    id: "39",
    user: MOCK_USERS[0],
    content: "Trading psychology tip: Accept losses quickly, let winners run. Your ego will fight this, but your account will thank you. 🧠✨",
    topic: "materials",
    timestamp: new Date(Date.now() - 435 * 60000),
    likes: 656,
    comments: 118,
    shares: 53,
  },
  {
    id: "40",
    user: MOCK_USERS[2],
    content: "Backtested my strategy over 500 trades: 62% win rate with 2.1 R:R. Numbers don't lie. Test your edge before trading live! 📊🔬",
    topic: "materials",
    timestamp: new Date(Date.now() - 495 * 60000),
    likes: 478,
    comments: 83,
    shares: 36,
  },
  {
    id: "41",
    user: MOCK_USERS[5],
    content: "Failed my first evaluation but learned more from that than from 10 winning trades. Failure is feedback, not final. Keep pushing! 💪🎯",
    topic: "materials",
    timestamp: new Date(Date.now() - 555 * 60000),
    likes: 891,
    comments: 167,
    shares: 72,
  },
  {
    id: "42",
    user: MOCK_USERS[1],
    content: "Morning routine: Review plan, check economic calendar, meditate 10 min, then trade. Preparation = performance. 🌅📋",
    topic: "materials",
    timestamp: new Date(Date.now() - 615 * 60000),
    likes: 543,
    comments: 96,
    shares: 41,
  },
  // STOCKS ADDITIONAL POSTS
  {
    id: "43",
    user: MOCK_USERS[3],
    content: "MSFT breaking ATH! Cloud computing sector on fire. Long position from $405, now at $418. Tech dominance continues! ☁️💻",
    topic: "stocks",
  ...
  },
  {
    id: "44",
    user: MOCK_USERS[6],
    content: "Healthcare rotation happening! UNH, CVS showing strength. Defensive sectors getting love. +$2,670 on healthcare plays. 🏥💊",
    topic: "stocks",
  ...
  // CRYPTO ADDITIONAL POST
  {
    id: "45",
    user: MOCK_USERS[2],
    content: "Layer 2 tokens exploding! MATIC up 25% today. Scaling solutions are the future. Entered early, up $3,450. Innovation wins! ⚡🔷",
    topic: "crypto",
    timestamp: new Date(Date.now() - 120 * 60000),
    likes: 467,
    comments: 79,
  ...
  // FOREX ADDITIONAL POSTS
  {
    id: "46",
    user: MOCK_USERS[4],
    content: "CHF pairs showing interesting setups. EUR/CHF and GBP/CHF both at key levels. Safe haven flow analysis paying off. 🇨🇭💰",
    topic: "forex",
    timestamp: new Date(Date.now() - 780 * 60000),
    likes: 143,
    comments: 24,
    shares: 8,
  },
  {
    id: "47",
    user: MOCK_USERS[5],
    content: "Asian session trading: USD/JPY respecting 149.50 support perfectly. Tokyo hours offer great setups if you're disciplined. 🗾📊",
    topic: "forex",
    timestamp: new Date(Date.now() - 840 * 60000),
    likes: 198,
    comments: 32,
    shares: 11,
  },
  {
    id: "48",
    user: MOCK_USERS[6],
    content: "Caught the EUR/GBP breakout! Cross pairs offering better moves than majors lately. +$2,890 on this setup. 🇪🇺🇬🇧",
    topic: "forex",
    timestamp: new Date(Date.now() - 900 * 60000),
    likes: 267,
    comments: 43,
    shares: 14,
  },
